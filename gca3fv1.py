...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(732, 722)
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 1421, 31))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.mainGroup = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.mainGroup.setGeometry(QtCore.QRect(10, 40, 711, 631))
        ...
        database_name = 'GB_TIMAH_DATA'  # Change this to your database name
    ...
    def load_record(self, index):
        ...
        if 0 <= index < len(records):
            ...
            self.txtSiteID.setText(str(record[2]))  # Konversi integer menjadi string
            self.txtLapis.setText(str(record[4]))
            self.txtBrtTbg.setText(str(record[10]))
            self.txtBulan.setText(str(record[5]))
            self.txtLok.setText(str(record[8]))  # Konversi integer menjadi string
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Sample ID"))
