...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(846, 879)
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 821, 831))
        ...
        self.tglSampai.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 4, 1), QtCore.QTime(0, 0, 0)))
        ...
        self.rbP48.toggled.connect(self.checkRadioButtons)
    ...
    def checkRadioButtons(self):
        ...
        rbP48_checked = self.rbP48.isChecked()
        rbP100_checked = self.rbP100.isChecked()
        rbM100_checked = self.rbM100.isChecked()

        # Aktifkan scrollArea jika salah satu tombol radio terpilih, nonaktifkan jika tidak ada yang terpilih
        self.scrollArea.setEnabled(rbP48_checked or rbP100_checked or rbM100_checked)
